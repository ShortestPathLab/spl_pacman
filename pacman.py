...
def readCommand( argv ):
    ...
    parser.add_option('-l', '--layout', dest='layout',
                      ...
                      metavar='LAYOUT_FILE', default='layouts/mediumClassic.lay')
...
def runGames( layout, pacman, ghosts, display, numGames, record, numTraining = 0, catchExceptions=False, timeout=30, *args, **kwargs):
    ...
    # otherwise get all layout files in the directory
        ...
        layoutNames = [filename for filename in os.listdir("layouts") if filename.endswith('.lay')]
    ...
    for i in range( numGames ):
        ...
        if nextLayout == None: 
            print("The layout file cannot be found: "+layoutNames[(i % len(layoutNames))])
            sys.exit(66)
